    ...
    render() {
        return (
            <div className="buttons">
                ...
                <button name=")" onClick ={this.buttonPressed}>)</button>
                <button name="CE" id ="tool" onClick ={this.buttonPressed}>CE</button>
                <button name="/" id ="tool" onClick ={this.buttonPressed}>/</button>
                ...
                <button name="." onClick ={this.buttonPressed}>.</button>
                <button name="C" id ="tool" onClick ={this.buttonPressed}>C</button>
                <button name="=" id ="tool" onClick ={this.buttonPressed}>=</button>
            </div>
        )
    }
